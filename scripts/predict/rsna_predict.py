...
if LABEL_COMPLEXITY:
    ...
    val_subset = np.load("rsna_val_subset.npy")
else:
    from utils import models

for _, model_name, weak_supervision in models:
    prediction_dir = os.path.join(rsna_dir, "predictions", model_name)
    ...
    if os.path.exists(os.path.join(prediction_dir, prediction_file_name)):
        continue
